...
export interface ResolvedPanelAssets {
  ...
  holdBottomCapInactive: ResolvedSpriteAsset | null;
  rollBodyInactive: ResolvedSpriteAsset | null;
  rollBottomCapInactive: ResolvedSpriteAsset | null;
...
export const loadResolvedDanceNoteskin = async (
  ...
  for (const panel of Object.keys(panelToButton) as PanelName[]) {
    ...
    panelAssets[panel] = {
      ...
      holdBottomCapInactive: await resolvePanelAsset(
        definitionCache,
        rootDefinition.id,
        buttonName,
      ...
      rollBodyInactive: await resolvePanelAsset(
        definitionCache,
        rootDefinition.id,
        buttonName,
        "Roll Body Inactive",
      ...
      rollBottomCapInactive: await resolvePanelAsset(
        definitionCache,
        rootDefinition.id,
        buttonName,
